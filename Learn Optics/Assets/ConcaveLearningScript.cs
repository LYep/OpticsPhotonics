    ...
    public class ConcaveLearningScript : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            texts = new string[] {"Welcome to the concave lens lesson.", "This is a concave, or diverging, lens.", "It's called a diverging lens because light rays that pass through the lens diverge from its focal point. ",
                    ...
                    "Finally, draw a ray that approaches the right focal point of the lens.", "This will emerge parallel to the optical axis.", "Now trace the rays backwards without deviating their path", "The image is always upright, virtual, and in front of the object.",
        ...
        public void OnClick()
        {
            ...
            switch (counter)
            {
                ...
                case 19:
                    ...
                    FocalLengthBar.transform.GetChild(0).GetComponent<TextMesh>().text = "-12m";
                    break;
